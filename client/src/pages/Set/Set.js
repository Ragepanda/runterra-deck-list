  ...
  render() {
    ...
    return (
      ...
      <div className="container-fluid" id="neg-margin">
        ...
        <div className="setName text-center pb-5 pt-1"><p>This is the list of Legends of Runeterra cards in the Legends of Runeterra base set. Runeterra Nexus is the spot to view new Legends of Runeterra sets.</p></div>
