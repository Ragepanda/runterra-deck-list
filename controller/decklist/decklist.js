        ...
        res.send(
            ...
            },
            {
            ...
            },
             {
                ...
                name: "Himerdinger Control", 
                description: "This is a control deck centered around Himerdinger. You want to use your cheap removal and stun effects to survive until you can stick a Himerdinger with Deny up to protect him. Once thats done its time to start spamming spells and build robot army to gain control of the game. The deck runs as many spells as possible to allow for Corina Veraza to be a reliable back up win condition.", 
            ...
            },
             {
                ...
                name: "EZ Combo", 
                description: "The goal of this deck is level up Ezreal and spam spells to kill your opponents with Ezreals ability. You should try to hold of on play Ezreal until he is ready to level up so he is harder to kill and you can start pinging your oppoenent immediately.", 
                cardArtId: "01PZ036T1" 
            },
              {
                id: 5, 
                code: 'CEBAEAIDBMKASAIEAEIBWJZLGQ3TQOQBAMAQIBRCGEAQCAIEEM', 
                name: "HimerDraven Midrange", 
                description: "Draven and Himer in the same deck? This is a supringly effective midrange build witha ton of synergy. Draven generates tons Spinning Axes that fuel Rummage and Get Excited, cheapen Plaza Guadians, and trigger Jae Medarda. All of the card draw helps grow our Astute Academics, and Sumpsnipe Scavanger can close out the game by giving a big threat elusive.", 
                cardArtId: "01NX020" 
            },
             {
                id: 6, 
                ...
                description: "This is the 1st attempt at the Purrsuit of Perfection, we are going to try and the control Suite of Shadow Isles and Piltover and Zaun to give use enough time to play 20 different cards and find our Purrsuit. This deck will need a ton of tweaking to find out how much we can get away with given the meta.", 
                cardArtId: "01PZ033T1" 
            },
